...
class UserModel {
    ...
    let address: String
    var isFollowed: Bool
    init(name: String, avatar: String, desc: String, address: String, isFollowed: Bool = false) {
        self.name = name
        self.avatar = avatar
        self.desc = desc
...
var contactList: [UserModel] = [
    UserModel(name: "懒羊羊", avatar: "avatar1", desc: "我的梦就是每天睡饱了吃，吃饱了睡~~~",address: "羊村",isFollowed: true),
    UserModel(name: "喜羊羊", avatar: "avatar2", desc: "今天天气不错，去看看灰太狼有没有来羊村捣乱",address: "羊村"),
    UserModel(name: "美羊羊", avatar: "avatar3", desc: "今天心情很美丽呢",address: "羊村",isFollowed: true),
